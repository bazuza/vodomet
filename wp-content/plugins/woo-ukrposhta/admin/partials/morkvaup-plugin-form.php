...
if (isset($_POST['phone1']) && isset($_POST['phone2']) && !$failed && !isset($_POST['international'])) {
    ...
    $message .= '<br>Можливі інші невідомі помилки. ';
...
<div class="tablecontainer">
  <table class="form-table full-width-input i4x"  id="i4x">
    <tbody>
      <tr class="international-inner" t=user1>
        <th colspan=2>
          <h3 class="formblock_title">Відправник (заповнювати латиницею)</h3>
          <div id="errors"></div>
        </th>
      </tr>
  ...
  <table id=i5x class="form-table full-width-input i5x">
    <tbody>
      ...
      <tr class="international-inner">
        <th colspan=2>
          <h3 class="formblock_title">Одержувач (заповнювати латиницею)</h3>
        </th>
      </tr>
      <tr  class="international-inner">
        <th scope="row">
        ...
        <td>
          ...
          <input id="country_rec" type="text" name="country_rec" list="country" value="<?php echo $order_data['billing']['country']; ?>"  />
    ...
    <tbody>
        <tr>
          <td>
            ...
            <input type="submit" value="Створити" class="morkvaup_checkforminputs button button-primary" id="submit"/>
          </td>
        </tr>
      </tbody>
    </table>
