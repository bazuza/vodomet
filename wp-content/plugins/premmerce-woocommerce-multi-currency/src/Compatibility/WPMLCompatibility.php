...
class WPMLCompatibility
{
    ...
    public function __construct()
    {
        ...
        add_action('wcml_update_extra_fields', [$this, 'syncTranslatedProductCurrencyFields'], 10, 2);

        add_action('wcml_before_sync_product_data', [$this, 'syncVariationPricesInProcuctCurrencies']);
    ...
    public function syncVariationPricesInProcuctCurrencies(){
        ...
        $fields = ['_product_currency_regular_price', '_product_currency_sale_price'];
