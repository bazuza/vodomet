...

{
     ...
     * @var array
     */
    private $priceArgsForOrderDisplay = [];
    ...
    public function __construct(Model $model, UserCurrencyHandler $userCurrencyHandler, UserPricesHandler $userPricesHandler)
    {
         ...
         *
         */
        add_filter('woocommerce_order_formatted_line_subtotal', [$this, 'formatOrderLineSubtotal'], 10, 4);
        add_filter('woocommerce_get_order_item_totals', [$this, 'formatOrderItemTotals'], 10, 3);
        add_filter('woocommerce_get_formatted_order_total', [$this, 'formatOrderTotals'], 10, 4);


        add_filter('woocommerce_admin_order_item_headers', [$this, 'replaceCurrencyParams']);


        //Write order currency id to DB
        add_action('woocommerce_new_order', [$this, 'addOrderCurrencyId']);

        add_action('woocommerce_new_order_item', [$this, 'adjustOrderItemPrice'], 10, 3);
    ...
    public function formatOrderPriceLines($formattedFields, \WC_Order $order, $args)
    {
        ...
        add_filter('wc_price_args', [$this, 'replacePriceArgsForOrderDisplay']);
        add_filter('woocommerce_currency_symbol', [$this, 'replaceCurrencySymbolForOrderDisplay']);
        ...
        remove_filter($currentFilter, [$this, $function]);
        ...
        remove_filter('wc_price_args', [$this, 'replacePriceArgsForOrderDisplay']);
        remove_filter('woocommerce_currency_symbol', [$this, 'replaceCurrencySymbolForOrderDisplay']);


        //Set current filter again for the next order or order field
        add_filter($currentFilter, [$this, $function], 10, $argsNum);
